...
export class CreateUser1707976885941 implements MigrationInterface {
 ...
 public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users_roles" ("usersId" integer NOT NULL, "roleId" integer NOT NULL, CONSTRAINT "PK_1a2bd35f3bd9ea08c6077cd4f13" PRIMARY KEY ("usersId", "roleId"))`);
